...
abstract class HeaderBehavior<V extends View> extends ViewOffsetBehavior<V> {
    ...
    final int setHeaderTopBottomOffset(CoordinatorLayout parent, V header, int newOffset) {
    ...
    final boolean fling(CoordinatorLayout coordinatorLayout, V layout, int minOffset, int maxOffset, float velocityY) {
        ...
        this.mScroller.fling(0, getTopAndBottomOffset(), 0, Math.round(velocityY), 0, 0, minOffset, 0);
