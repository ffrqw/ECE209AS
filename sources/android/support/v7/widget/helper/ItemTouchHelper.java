...
public final class ItemTouchHelper extends ItemDecoration implements OnChildAttachStateChangeListener {
    ...
    private class RecoverAnimation implements AnimatorListenerCompat {
        ...
        public RecoverAnimation(ViewHolder viewHolder, int animationType, int actionState, float startDx, float startDy, float targetX, float targetY) {
            ...
            this.mValueAnimator.addUpdateListener(new AnimatorUpdateListenerCompat(ItemTouchHelper.this) {
                public final void onAnimationUpdate(ValueAnimatorCompat animation) {
    ...
    public static abstract class Callback {
        ...
        public static int makeFlag(int actionState, int directions) {
            return directions << (actionState << 3);
        }
    ...
    public final void onDrawOver(Canvas c, RecyclerView parent, State state) {
        float dx = 0.0f;
        float dy = 0.0f;
    ...
    public final void onDraw(Canvas c, RecyclerView parent, State state) {
        this.mOverdrawChildPosition = -1;
        float dx = 0.0f;
        float dy = 0.0f;
        if (this.mSelected != null) {
    ...
    final void select(ViewHolder selected, int actionState) {
        if (selected != this.mSelected || actionState != this.mActionState) {
            ...
            if (this.mSelected != null) {
                ...
                if (prevSelected.itemView.getParent() != null) {
                    ...
                    RecoverAnimation rv = new RecoverAnimation(prevSelected, animationType, prevActionState, currentTranslateX, currentTranslateY, targetTranslateX, targetTranslateY) {
                        public final void onAnimationEnd(ValueAnimatorCompat animation) {
            ...
            if (selected != null) {
                this.mSelectedFlags = (this.mCallback.getAbsoluteMovementFlags(this.mRecyclerView, selected) & actionStateMask) >> (this.mActionState << 3);
    ...
    final void postDispatchSwipe(final RecoverAnimation anim, final int swipeDir) {
    ...
    final boolean hasRunningRecoverAnim() {
    ...
    final int endRecoverAnimation(ViewHolder viewHolder, boolean override) {
        for (int i = this.mRecoverAnimations.size() - 1; i >= 0; i--) {
    ...
    final void obtainVelocityTracker() {
    ...
    final boolean checkSelectForSwipe(int action, MotionEvent motionEvent, int pointerIndex) {
        ...
        int swipeFlags = (this.mCallback.getAbsoluteMovementFlags(this.mRecyclerView, vh) >> 8) & ACTION_MODE_IDLE_MASK;
        if (swipeFlags == 0) {
            return false;
        }
    ...
    final View findChildView(MotionEvent event) {
        float x = event.getX();
        float y = event.getY();
        if (this.mSelected != null) {
    ...
    public final void startSwipe(ViewHolder viewHolder) {
    ...
    final RecoverAnimation findAnimation(MotionEvent event) {
    ...
    final void updateDxDy(MotionEvent ev, int directionFlags, int pointerIndex) {
    ...
    private int swipeIfNecessary(ViewHolder viewHolder) {
        ...
        int flags = (this.mCallback.convertToAbsoluteDirection(originalMovementFlags, ViewCompat.getLayoutDirection(this.mRecyclerView)) >> 8) & ACTION_MODE_IDLE_MASK;
        if (flags == 0) {
            return 0;
        }
        int originalFlags = (originalMovementFlags >> 8) & ACTION_MODE_IDLE_MASK;
        int swipeDir;
        ...
        if (VERSION.SDK_INT < 21) {
            if (this.mChildDrawingOrderCallback == null) {
                this.mChildDrawingOrderCallback = new ChildDrawingOrderCallback() {
                    public final int onGetChildDrawingOrder(int childCount, int i) {
