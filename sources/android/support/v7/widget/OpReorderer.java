...
final class OpReorderer {
    ...
    final void reorderOps(List<UpdateOp> ops) {
        while (true) {
    ...
    final void swapMoveRemove(List<UpdateOp> list, int movePos, UpdateOp moveOp, int removePos, UpdateOp removeOp) {
    ...
    final void swapMoveUpdate(List<UpdateOp> list, int move, UpdateOp moveOp, int update, UpdateOp updateOp) {
