...
public class CardView extends FrameLayout {
    ...
    private void initialize(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.CardView, defStyleAttr, com.rachio.iro.R.style.CardView);
        if (a.hasValue(R.styleable.CardView_cardBackgroundColor)) {
            ...
            if (hsv[2] > 0.5f) {
                color = getResources().getColor(com.rachio.iro.R.color.cardview_light_background);
            } else {
                color = getResources().getColor(com.rachio.iro.R.color.cardview_dark_background);
            }
