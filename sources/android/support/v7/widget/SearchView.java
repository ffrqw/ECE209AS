...
public final class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    private static class AutoCompleteTextViewReflector {
        ...
        final void doBeforeTextChanged(AutoCompleteTextView view) {
        ...
        final void doAfterTextChanged(AutoCompleteTextView view) {
        ...
        final void ensureImeVisible(AutoCompleteTextView view, boolean visible) {
        ...
        final void showSoftInputUnchecked(InputMethodManager imm, View view, int flags) {
    ...
    public SearchView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, attrs, android.support.v7.appcompat.R.styleable.SearchView, defStyleAttr, 0);
        LayoutInflater.from(context).inflate(a.getResourceId(android.support.v7.appcompat.R.styleable.SearchView_layout, R.layout.abc_search_view), this, true);
        ...
        ViewCompat.setBackground(this.mSearchPlate, a.getDrawable(android.support.v7.appcompat.R.styleable.SearchView_queryBackground));
        ViewCompat.setBackground(this.mSubmitArea, a.getDrawable(android.support.v7.appcompat.R.styleable.SearchView_submitBackground));
        this.mSearchButton.setImageDrawable(a.getDrawable(android.support.v7.appcompat.R.styleable.SearchView_searchIcon));
        this.mGoButton.setImageDrawable(a.getDrawable(android.support.v7.appcompat.R.styleable.SearchView_goIcon));
        this.mCloseButton.setImageDrawable(a.getDrawable(android.support.v7.appcompat.R.styleable.SearchView_closeIcon));
        this.mVoiceButton.setImageDrawable(a.getDrawable(android.support.v7.appcompat.R.styleable.SearchView_voiceIcon));
        this.mCollapsedIcon.setImageDrawable(a.getDrawable(android.support.v7.appcompat.R.styleable.SearchView_searchIcon));
        this.mSearchHintIcon = a.getDrawable(android.support.v7.appcompat.R.styleable.SearchView_searchHintIcon);
        this.mSuggestionRowLayout = a.getResourceId(android.support.v7.appcompat.R.styleable.SearchView_suggestionRowLayout, R.layout.abc_search_dropdown_item_icons_2line);
        this.mSuggestionCommitIconResId = a.getResourceId(android.support.v7.appcompat.R.styleable.SearchView_commitIcon, 0);
        ...
        int maxWidth = a.getDimensionPixelSize(android.support.v7.appcompat.R.styleable.SearchView_android_maxWidth, -1);
        if (maxWidth != -1) {
            setMaxWidth(maxWidth);
        }
        this.mDefaultQueryHint = a.getText(android.support.v7.appcompat.R.styleable.SearchView_defaultQueryHint);
        this.mQueryHint = a.getText(android.support.v7.appcompat.R.styleable.SearchView_queryHint);
        int imeOptions = a.getInt(android.support.v7.appcompat.R.styleable.SearchView_android_imeOptions, -1);
        if (imeOptions != -1) {
            setImeOptions(imeOptions);
        }
        int inputType = a.getInt(android.support.v7.appcompat.R.styleable.SearchView_android_inputType, -1);
        if (inputType != -1) {
    ...
    public final void setAppSearchData(Bundle appSearchData) {
    ...
    public final void setOnQueryTextFocusChangeListener(OnFocusChangeListener listener) {
        this.mOnQueryTextFocusChangeListener = listener;
    }

    public final void setOnSuggestionListener(OnSuggestionListener listener) {
        this.mOnSuggestionListener = listener;
    }

    public final void setOnSearchClickListener(OnClickListener listener) {
    ...
    public final boolean isIconfiedByDefault() {
        return this.mIconifiedByDefault;
    }

    public final void setIconified(boolean iconify) {
        if (iconify) {
            onCloseClicked();
        } else {
            onSearchClicked();
    ...
    public final void setQueryRefinementEnabled(boolean enable) {
    ...
    public final boolean isQueryRefinementEnabled() {
    ...
    L_0x000b:
        return;
    L_0x000c:
        r3 = android.view.View.MeasureSpec.getMode(r7);
        r2 = android.view.View.MeasureSpec.getSize(r7);
        switch(r3) {
            case -2147483648: goto L_0x002e;
            case 0: goto L_0x004d;
            case 1073741824: goto L_0x0042;
    ...
    L_0x0017:
        ...
        switch(r1) {
            case -2147483648: goto L_0x0059;
            case 0: goto L_0x0062;
            default: goto L_0x0022;
        };
    L_0x0022:
        r4 = android.view.View.MeasureSpec.makeMeasureSpec(r2, r5);
        r5 = android.view.View.MeasureSpec.makeMeasureSpec(r0, r5);
    ...
    L_0x0051:
        ...
        goto L_0x0038;
    L_0x0054:
        r2 = r6.getPreferredWidth();
        goto L_0x0038;
    L_0x0059:
        r4 = r6.getPreferredHeight();
        r0 = java.lang.Math.min(r4, r0);
        goto L_0x0022;
    L_0x0062:
        r0 = r6.getPreferredHeight();
        goto L_0x0022;
        */
    ...
    final void setImeVisibility(boolean visible) {
        if (visible) {
    ...
    final void onQueryRefine(CharSequence queryText) {
        setQuery(queryText);
    }

    final boolean onSuggestionsKey(View v, int keyCode, KeyEvent event) {
    ...
    final void onTextChanged(CharSequence newText) {
        boolean hasText;
        boolean z = true;
    ...
    final boolean onItemClicked(int position, int actionKey, String actionMsg) {
    ...
    final boolean onItemSelected(int position) {
    ...
    final void launchQuerySearch(int actionKey, String actionMsg, String query) {
    ...
    final void forceSuggestionQuery() {
