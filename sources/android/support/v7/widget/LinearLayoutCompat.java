            ...
            for (i = 0; i < count; i++) {
                ...
                if (child.getVisibility() != 8) {
                    ...
                    if (childExtra > 0.0f) {
                        ...
                        child2.measure(childWidthMeasureSpec, MeasureSpec.makeMeasureSpec(share, 1073741824));
            ...
            for (i2 = 0; i2 < count; i2++) {
                ...
                if (!(child == null || child.getVisibility() == 8)) {
                    ...
                    if (childExtra > 0.0f) {
                        ...
                        child2.measure(MeasureSpec.makeMeasureSpec(share, 1073741824), childHeightMeasureSpec);
