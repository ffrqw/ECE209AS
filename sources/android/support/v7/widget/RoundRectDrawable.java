...
final class RoundRectDrawable extends Drawable {
    ...
    final void setPadding(float padding, boolean insetForPadding, boolean insetForRadius) {
    ...
    final void setRadius(float radius) {
    ...
    public final void setColor(ColorStateList color) {
        setBackground(color);
        invalidateSelf();
    }
