...
final class ViewBoundsCheck {
    ...
    static class BoundFlags {
        ...
        final void setBounds(int rvStart, int rvEnd, int childStart, int childEnd) {
    ...
    final View findOneViewWithinBoundFlags(int fromIndex, int toIndex, int preferredBoundFlags, int acceptableBoundFlags) {
    ...
    final boolean isViewWithinBoundFlags(View child, int boundsFlags) {
