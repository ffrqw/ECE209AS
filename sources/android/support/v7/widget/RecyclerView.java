...
public class RecyclerView extends ViewGroup implements NestedScrollingChild, ScrollingView {
    ...
    public static abstract class ItemAnimator {
        ...
        public static class ItemHolderInfo {
            ...
            public final ItemHolderInfo setFrom(ViewHolder holder, int flags) {
    ...
    public static abstract class SmoothScroller {
        ...
        public static class Action {
            ...
            public final void jumpTo(int targetPosition) {
                this.mJumpToPosition = targetPosition;
            }

            final boolean hasJumpTarget() {
    ...
    public static class RecycledViewPool {
        ...
        public final int getRecycledViewCount(int viewType) {
        ...
        final long runningAverage(long oldAverage, long newValue) {
            return oldAverage == 0 ? newValue : ((oldAverage / 4) * 3) + (newValue / 4);
        }

        final void factorInCreateTime(int viewType, long createTimeNs) {
            ScrapData scrapData = getScrapDataForType(viewType);
            scrapData.mCreateRunningAverageNs = runningAverage(scrapData.mCreateRunningAverageNs, createTimeNs);
        }

        final void factorInBindTime(int viewType, long bindTimeNs) {
            ScrapData scrapData = getScrapDataForType(viewType);
            scrapData.mBindRunningAverageNs = runningAverage(scrapData.mBindRunningAverageNs, bindTimeNs);
        }

        final boolean willCreateInTime(int viewType, long approxCurrentNs, long deadlineNs) {
            long expectedDurationNs = getScrapDataForType(viewType).mCreateRunningAverageNs;
            return expectedDurationNs == 0 || approxCurrentNs + expectedDurationNs < deadlineNs;
        }

        final boolean willBindInTime(int viewType, long approxCurrentNs, long deadlineNs) {
            long expectedDurationNs = getScrapDataForType(viewType).mBindRunningAverageNs;
            return expectedDurationNs == 0 || approxCurrentNs + expectedDurationNs < deadlineNs;
        }

        final void attach(Adapter adapter) {
            this.mAttachCount++;
        }
        ...
        final void onAdapterChanged(Adapter oldAdapter, Adapter newAdapter, boolean compatibleWithPrevious) {
            if (oldAdapter != null) {
                detach();
            }
    ...
    public final class Recycler {
        ...
        public final void setViewCacheSize(int viewCount) {
        ...
        final boolean validateViewHolderForOffsetPosition(ViewHolder holder) {
            if (holder.isRemoved()) {
        ...
        final View getViewForPosition(int position, boolean dryRun) {
            return tryGetViewHolderForPositionByDeadline(position, dryRun, RecyclerView.FOREVER_NS).itemView;
        }

        final ViewHolder tryGetViewHolderForPositionByDeadline(int position, boolean dryRun, long deadlineNs) {
            if (position < 0 || position >= RecyclerView.this.mState.getItemCount()) {
        ...
        final void recycleViewHolderInternal(ViewHolder holder) {
            ...
            if (holder.isScrap() || holder.itemView.getParent() != null) {
                StringBuilder append = new StringBuilder("Scrapped or attached views may not be recycled. isScrap:").append(holder.isScrap()).append(" isAttached:");
        ...
        final void addViewHolderToRecycledViewPool(ViewHolder holder, boolean dispatchRecycled) {
        ...
        final View getScrapViewAt(int index) {
        ...
        final ViewHolder getChangedScrapViewForPosition(int position) {
            if (this.mChangedScrap != null) {
        ...
        final ViewHolder getScrapOrHiddenOrCachedHolderForPosition(int position, boolean dryRun) {
        ...
        final ViewHolder getScrapOrCachedViewForId(long id, int type, boolean dryRun) {
            int i;
        ...
        final void dispatchViewRecycled(ViewHolder holder) {
        ...
        final void offsetPositionRecordsForMove(int from, int to) {
            int inBetweenOffset;
            int start;
            int end;
            if (from < to) {
        ...
        final void offsetPositionRecordsForInsert(int insertedAt, int count) {
            int cachedCount = this.mCachedViews.size();
            for (int i = 0; i < cachedCount; i++) {
                ViewHolder holder = (ViewHolder) this.mCachedViews.get(i);
        ...
        final void offsetPositionRecordsForRemove(int removedFrom, int count, boolean applyToPreLayout) {
        ...
        final void setViewCacheExtension(ViewCacheExtension extension) {
            this.mViewCacheExtension = extension;
        }

        final void setRecycledViewPool(RecycledViewPool pool) {
        ...
        final void viewRangeUpdate(int positionStart, int itemCount) {
    ...
    public static class SavedState extends AbsSavedState {
        ...
        final void copyFrom(SavedState other) {
    ...
    public static class State {
        ...
        final void prepareForNestedPrefetch(Adapter adapter) {
            this.mLayoutStep = 1;
        ...
        public final void remove(int resourceId) {
            if (this.mData != null) {
                this.mData.remove(resourceId);
            }
        }

        public final <T> T get(int resourceId) {
            if (this.mData == null) {
                return null;
            }
        ...
        public final void put(int resourceId, Object data) {
            if (this.mData == null) {
    ...
    class ViewFlinger implements Runnable {
        ...
        public final void smoothScrollBy(int dx, int dy, int vx, int vy) {
    ...
    public RecyclerView(Context context, AttributeSet attrs, int defStyle) {
        ...
        this.mViewInfoProcessCallback = new ProcessCallback() {
            public final void processDisappeared(ViewHolder viewHolder, ItemHolderInfo info, ItemHolderInfo postInfo) {
                RecyclerView.this.mRecycler.unscrapView(viewHolder);
                RecyclerView.this.animateDisappearance(viewHolder, info, postInfo);
            }

            public final void processAppeared(ViewHolder viewHolder, ItemHolderInfo preInfo, ItemHolderInfo info) {
                RecyclerView.this.animateAppearance(viewHolder, preInfo, info);
            }

            public final void processPersistent(ViewHolder viewHolder, ItemHolderInfo preInfo, ItemHolderInfo postInfo) {
    ...
    private void initChildrenHelper() {
        this.mChildHelper = new ChildHelper(new Callback() {
            ...
            public final void attachViewToParent(View child, int index, android.view.ViewGroup.LayoutParams layoutParams) {
                ViewHolder vh = RecyclerView.getChildViewHolderInt(child);
                if (vh != null) {
    ...
    void initAdapterManager() {
        this.mAdapterHelper = new AdapterHelper(new Callback() {
            ...
            public final void onDispatchFirstPass(UpdateOp op) {
                dispatchUpdate(op);
            }

            final void dispatchUpdate(UpdateOp op) {
                switch (op.cmd) {
                    case 1:
            ...
            public final void onDispatchSecondPass(UpdateOp op) {
                dispatchUpdate(op);
            }
    ...
    private boolean isPreferredNextFocusAbsolute(View focused, View next, int direction) {
        ...
        switch (direction) {
            case 17:
                ...
                return false;
            case com.shinobicontrols.charts.R.styleable.ChartTheme_sc_seriesLineColor1 /*33*/:
                ...
                return false;
            case com.shinobicontrols.charts.R.styleable.ChartTheme_sc_financialRisingColor /*66*/:
