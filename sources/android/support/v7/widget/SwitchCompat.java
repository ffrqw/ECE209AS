...
public class SwitchCompat extends CompoundButton {
    ...
    public SwitchCompat(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        Mode thumbTintMode = DrawableUtils.parseTintMode(a.getInt(android.support.v7.appcompat.R.styleable.SwitchCompat_thumbTintMode, -1), null);
        ...
        Mode trackTintMode = DrawableUtils.parseTintMode(a.getInt(android.support.v7.appcompat.R.styleable.SwitchCompat_trackTintMode, -1), null);
    ...
    public void setSwitchTextAppearance(Context context, int resid) {
        ...
        setSwitchTypefaceByIndex(appearance.getInt(android.support.v7.appcompat.R.styleable.TextAppearance_android_typeface, -1), appearance.getInt(android.support.v7.appcompat.R.styleable.TextAppearance_android_textStyle, -1));
    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (this.mShowText) {
            maxTextWidth = Math.max(this.mOnLayout.getWidth(), this.mOffLayout.getWidth()) + (this.mThumbTextPadding << 1);
        } else {
            maxTextWidth = 0;
        }
