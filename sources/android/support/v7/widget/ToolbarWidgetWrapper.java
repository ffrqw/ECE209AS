...
public final class ToolbarWidgetWrapper implements DecorToolbar {
    ...
    public ToolbarWidgetWrapper(Toolbar toolbar, boolean style, int defaultNavigationContentDescription, int defaultNavigationIcon) {
        ...
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(toolbar.getContext(), null, android.support.v7.appcompat.R.styleable.ActionBar, R.attr.actionBarStyle, 0);
        this.mDefaultNavigationIcon = a.getDrawable(android.support.v7.appcompat.R.styleable.ActionBar_homeAsUpIndicator);
        if (style) {
            CharSequence title = a.getText(android.support.v7.appcompat.R.styleable.ActionBar_title);
            if (!TextUtils.isEmpty(title)) {
                setTitle(title);
            }
            CharSequence subtitle = a.getText(android.support.v7.appcompat.R.styleable.ActionBar_subtitle);
            if (!TextUtils.isEmpty(subtitle)) {
                setSubtitle(subtitle);
            }
            Drawable logo = a.getDrawable(android.support.v7.appcompat.R.styleable.ActionBar_logo);
            if (logo != null) {
                setLogo(logo);
            }
            Drawable icon = a.getDrawable(android.support.v7.appcompat.R.styleable.ActionBar_icon);
            if (icon != null) {
                setIcon(icon);
            }
            ...
            setDisplayOptions(a.getInt(android.support.v7.appcompat.R.styleable.ActionBar_displayOptions, 0));
            int customNavId = a.getResourceId(android.support.v7.appcompat.R.styleable.ActionBar_customNavigationLayout, 0);
            if (customNavId != 0) {
            ...
            int contentInsetStart = a.getDimensionPixelOffset(android.support.v7.appcompat.R.styleable.ActionBar_contentInsetStart, -1);
            int contentInsetEnd = a.getDimensionPixelOffset(android.support.v7.appcompat.R.styleable.ActionBar_contentInsetEnd, -1);
            if (contentInsetStart >= 0 || contentInsetEnd >= 0) {
                this.mToolbar.setContentInsetsRelative(Math.max(contentInsetStart, 0), Math.max(contentInsetEnd, 0));
            }
            int titleTextStyle = a.getResourceId(android.support.v7.appcompat.R.styleable.ActionBar_titleTextStyle, 0);
            if (titleTextStyle != 0) {
                this.mToolbar.setTitleTextAppearance(this.mToolbar.getContext(), titleTextStyle);
            }
            int subtitleTextStyle = a.getResourceId(android.support.v7.appcompat.R.styleable.ActionBar_subtitleTextStyle, 0);
            if (subtitleTextStyle != 0) {
                this.mToolbar.setSubtitleTextAppearance(this.mToolbar.getContext(), subtitleTextStyle);
            }
            int popupTheme = a.getResourceId(android.support.v7.appcompat.R.styleable.ActionBar_popupTheme, 0);
            if (popupTheme != 0) {
    ...
    public final void setDefaultNavigationContentDescription(int defaultNavigationContentDescription) {
    ...
    public final void setWindowCallback(Callback cb) {
    ...
    public final void setLogo(Drawable d) {
        this.mLogo = d;
        updateToolbarLogo();
    }
    ...
    public final void setDisplayOptions(int newOpts) {
    ...
    public final void setEmbeddedTabView(ScrollingTabContainerView tabView) {
    ...
    public final void setHomeButtonEnabled(boolean enable) {
    }
    ...
    public final void setNavigationMode(int mode) {
    ...
    public final void setDropdownParams(SpinnerAdapter adapter, OnItemSelectedListener listener) {
        ensureSpinner();
        this.mSpinner.setAdapter(adapter);
        this.mSpinner.setOnItemSelectedListener(listener);
    }

    public final void setDropdownSelectedPosition(int position) {
        if (this.mSpinner == null) {
    ...
    public final void animateToVisibility(int visibility) {
    ...
    public final ViewPropertyAnimatorCompat setupAnimatorToVisibility(final int visibility, long duration) {
    ...
    public final void setDefaultNavigationIcon(Drawable defaultNavigationIcon) {
    ...
    public final void saveHierarchyState(SparseArray<Parcelable> toolbarStates) {
        this.mToolbar.saveHierarchyState(toolbarStates);
    }

    public final void restoreHierarchyState(SparseArray<Parcelable> toolbarStates) {
    ...
    public final void setMenuCallbacks(MenuPresenter.Callback actionMenuPresenterCallback, MenuBuilder.Callback menuBuilderCallback) {
