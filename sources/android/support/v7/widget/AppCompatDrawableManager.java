...
public final class AppCompatDrawableManager {
    ...
    private static class AvdcInflateDelegate implements InflateDelegate {
        ...
        @SuppressLint({"NewApi"})
        public final Drawable createFromXmlInner(Context context, XmlPullParser parser, AttributeSet attrs, Theme theme) {
            try {
    ...
    private static class ColorFilterLruCache extends LruCache<Integer, PorterDuffColorFilter> {
        ...
        final PorterDuffColorFilter get(int color, Mode mode) {
            return (PorterDuffColorFilter) get(Integer.valueOf(generateCacheKey(color, mode)));
        }

        final PorterDuffColorFilter put(int color, Mode mode, PorterDuffColorFilter filter) {
    ...
    final Drawable getDrawable(Context context, int resId, boolean failIfNotKnown) {
    ...
    final Drawable onDrawableLoadedFromResources(Context context, VectorEnabledTintResources resources, int resId) {
        Drawable drawable = loadDrawableFromDelegates(context, resId);
        if (drawable == null) {
    ...
    final ColorStateList getTintList(Context context, int resId) {
    ...
    private ColorStateList createButtonColorStateList(Context context, int baseColor) {
        ...
        states[2] = ThemeUtils.FOCUSED_STATE_SET;
        colors[2] = ColorUtils.compositeColors(colorControlHighlight, baseColor);
        states[3] = ThemeUtils.EMPTY_STATE_SET;
        colors[3] = baseColor;
