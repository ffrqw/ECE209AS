...
final class AppCompatSeekBarHelper extends AppCompatProgressBarHelper {
    ...
    final void setTickMark(Drawable tickMark) {
    ...
    final Drawable getTickMark() {
        return this.mTickMark;
    }

    final void setTickMarkTintList(ColorStateList tint) {
        this.mTickMarkTintList = tint;
        this.mHasTickMarkTint = true;
        applyTickMarkTint();
    }

    final ColorStateList getTickMarkTintList() {
        return this.mTickMarkTintList;
    }

    final void setTickMarkTintMode(Mode tintMode) {
        this.mTickMarkTintMode = tintMode;
        this.mHasTickMarkTintMode = true;
        applyTickMarkTint();
    }

    final Mode getTickMarkTintMode() {
