...
public final class LinearSmoothScroller extends SmoothScroller {
    ...
    protected final void onTargetFound(View targetView, State state, Action action) {
    ...
    protected final void onSeekTargetStep(int dx, int dy, State state, Action action) {
        if (getChildCount() == 0) {
            stop();
            return;
        }
    ...
    protected final int calculateTimeForDeceleration(int dx) {
    ...
    public final int calculateDyToMakeVisible(View view, int snapPreference) {
