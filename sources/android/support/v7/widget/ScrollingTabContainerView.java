...
public final class ScrollingTabContainerView extends HorizontalScrollView implements OnItemSelectedListener {
    ...
    private class TabView extends LinearLayoutCompat implements OnLongClickListener {
        ...
        public final void bindTab(Tab tab) {
            this.mTab = tab;
            update();
        }
    ...
    protected class VisibilityAnimListener implements ViewPropertyAnimatorListener {
        ...
        public final VisibilityAnimListener withFinalVisibility(ViewPropertyAnimatorCompat animation, int visibility) {
    ...
    public final void setAllowCollapse(boolean allowCollapse) {
    ...
    final TabView createTabView(Tab tab, boolean forAdapter) {
