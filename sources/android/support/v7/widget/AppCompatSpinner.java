...
public final class AppCompatSpinner extends Spinner implements TintableBackgroundView {
    ...
    private class DropdownPopup extends ListPopupWindow {
        ...
        public final void setPromptText(CharSequence hintText) {
        ...
        final boolean isVisibleToUser(View view) {
    ...
    public AppCompatSpinner(Context context, AttributeSet attrs, int defStyleAttr, int mode, Theme popupTheme) {
        ...
        if (popupTheme != null) {
            contextThemeWrapper = new ContextThemeWrapper(context, popupTheme);
            this = this;
        } else {
            int popupThemeResId = a.getResourceId(android.support.v7.appcompat.R.styleable.Spinner_popupTheme, 0);
            if (popupThemeResId != 0) {
                contextThemeWrapper = new ContextThemeWrapper(context, popupThemeResId);
                this = this;
    ...
    public final void setPopupBackgroundDrawable(Drawable background) {
        if (this.mPopup != null) {
    ...
    public final void setPopupBackgroundResource(int resId) {
    ...
    public final void setDropDownVerticalOffset(int pixels) {
        if (this.mPopup != null) {
    ...
    public final void setDropDownHorizontalOffset(int pixels) {
        if (this.mPopup != null) {
    ...
    public final void setDropDownWidth(int pixels) {
        if (this.mPopup != null) {
    ...
    public final void setPrompt(CharSequence prompt) {
        if (this.mPopup != null) {
    ...
    final int compatMeasureContentWidth(SpinnerAdapter adapter, Drawable background) {
        if (adapter == null) {
            return 0;
        }
        int width = 0;
