...
public class GridLayout extends ViewGroup {
    ...
    public static final Alignment BASELINE = new Alignment() {
        final int getGravityOffset(View view, int cellDelta) {
            return 0;
        }

        public final int getAlignmentValue(View view, int viewSize, int mode) {
        ...
        public final Bounds getBounds() {
            return new Bounds() {
                ...
                protected final void include(int before, int after) {
                    super.include(before, after);
                    this.size = Math.max(this.size, before + after);
                }

                protected final int size(boolean min) {
                    return Math.max(super.size(min), this.size);
                }

                protected final int getOffset(GridLayout gl, View c, Alignment a, int size, boolean hrz) {
    ...
    public static final Alignment FILL = new Alignment() {
        ...
        public final int getSizeInCell(View view, int viewSize, int cellSize) {
            return cellSize;
        }
    ...
    final class Axis {
        ...
        public final void setOrderPreserved(boolean orderPreserved) {
        ...
        final Arc[][] groupArcsByFirstVertex(Arc[] arcs) {
            int i;
            int i2 = 0;
            int N = getCount() + 1;
        ...
        private String arcsToString(List<Arc> arcs) {
            ...
            for (Arc arc : arcs) {
                ...
                if (src < dst) {
                    str = var + dst + "-" + var + src + SimpleComparison.GREATER_THAN_EQUAL_TO_OPERATION + value;
                } else {
                    str = var + src + "-" + var + dst + SimpleComparison.LESS_THAN_EQUAL_TO_OPERATION + (-value);
                }
                result.append(str);
            }
        ...
        public final int getMeasure(int measureSpec) {
        ...
        public final void layout(int size) {
    ...
    public static class LayoutParams extends MarginLayoutParams {
        ...
        protected final void setBaseAttributes(TypedArray attributes, int widthAttr, int heightAttr) {
    ...
    public GridLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        this.mDefaultGap = context.getResources().getDimensionPixelOffset(com.rachio.iro.R.dimen.default_gap);
