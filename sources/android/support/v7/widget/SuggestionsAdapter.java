...
final class SuggestionsAdapter extends ResourceCursorAdapter implements OnClickListener {
    ...
    public final void setQueryRefinement(int refineWhat) {
        this.mQueryRefinement = refineWhat;
    }

    public final int getQueryRefinement() {
    ...
    final Cursor getSearchManagerSuggestions(SearchableInfo searchable, String query, int limit) {
        if (searchable == null) {
            return null;
        }
