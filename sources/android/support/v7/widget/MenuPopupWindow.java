...
public final class MenuPopupWindow extends ListPopupWindow implements MenuItemHoverListener {
    ...
    public static class MenuDropDownListView extends DropDownListView {
        ...
        public final void setHoverListener(MenuItemHoverListener hoverListener) {
        ...
        public final boolean onHoverEvent(MotionEvent ev) {
    ...
    public final void setEnterTransition(Object enterTransition) {
        if (VERSION.SDK_INT >= 23) {
            this.mPopup.setEnterTransition((Transition) enterTransition);
        }
    }

    public final void setExitTransition(Object exitTransition) {
        if (VERSION.SDK_INT >= 23) {
    ...
    public final void setTouchModal(boolean touchModal) {
