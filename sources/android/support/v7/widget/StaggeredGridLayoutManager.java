...
public class StaggeredGridLayoutManager extends LayoutManager implements ScrollVectorProvider {
    ...
    class AnchorInfo {
        ...
        final void saveSpanReferenceLines(Span[] spans) {
        ...
        final void assignCoordinateFromPadding(int addedDistance) {
            if (this.mLayoutFromEnd) {
    ...
    static class LazySpanLookup {
        ...
        static class FullSpanItem implements Parcelable {
            public static final Creator<FullSpanItem> CREATOR = new Creator<FullSpanItem>() {
                public final FullSpanItem createFromParcel(Parcel in) {
                    return new FullSpanItem(in);
                }

                public final FullSpanItem[] newArray(int size) {
        ...
        final int invalidateAfter(int position) {
        ...
        final int getSpan(int position) {
            if (this.mData == null || position >= this.mData.length) {
                return -1;
            }
        ...
        final void setSpan(int position, Span span) {
            ensureSize(position);
            this.mData[position] = span.mIndex;
        }

        final int sizeForPosition(int position) {
        ...
        public final FullSpanItem getFirstFullSpanItemInRange(int minPos, int maxPos, int gapDir, boolean hasUnwantedGapAfter) {
            if (this.mFullSpanItems == null) {
                return null;
            }
    ...
    class Span {
        ...
        final void cacheReferenceLineAndClear(boolean reverseLayout, int offset) {
            int reference;
            if (reverseLayout) {
        ...
        final int findOnePartiallyOrCompletelyVisibleChild(int fromIndex, int toIndex, boolean completelyVisible, boolean acceptCompletelyVisible, boolean acceptEndPointInclusion) {
        ...
        final int findOneVisibleChild(int fromIndex, int toIndex, boolean completelyVisible) {
            return findOnePartiallyOrCompletelyVisibleChild(fromIndex, toIndex, completelyVisible, true, false);
        }

        final int findOnePartiallyVisibleChild(int fromIndex, int toIndex, boolean acceptEndPointInclusion) {
    ...
    boolean checkForGaps() {
        ...
        if (minPos == 0 && hasGapsToFix() != null) {
            ...
            FullSpanItem validFsi = this.mLazySpanLookup.getFirstFullSpanItemInRange(minPos, invalidFsi.mPosition, -invalidGapDir, true);
            if (validFsi == null) {
    ...
    public void onInitializeAccessibilityNodeInfoForItem(Recycler recycler, State state, View host, AccessibilityNodeInfoCompat info) {
        ...
        if (lp instanceof LayoutParams) {
            ...
            info.setCollectionItemInfo(CollectionItemInfoCompat.obtain(i, spanIndex, i3, i2, sglp.mFullSpan, false));
            return;
        }
    ...
    private int convertFocusDirectionToLayoutDirection(int focusDirection) {
        switch (focusDirection) {
            ...
            case 17:
                ...
                return -1;
            case R.styleable.ChartTheme_sc_seriesLineColor1 /*33*/:
                if (this.mOrientation != 1) {
                    return Integer.MIN_VALUE;
                }
                return -1;
