...
public class ActionBarContainer extends FrameLayout {
    ...
    public ActionBarContainer(Context context, AttributeSet attrs) {
        ...
        if (getId() == com.rachio.iro.R.id.split_action_bar) {
            this.mIsSplit = true;
    ...
    public void onFinishInflate() {
        ...
        this.mActionBarView = findViewById(com.rachio.iro.R.id.action_bar);
        this.mContextView = findViewById(com.rachio.iro.R.id.action_context_bar);
    }
