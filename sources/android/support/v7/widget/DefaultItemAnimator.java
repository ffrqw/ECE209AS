...
public final class DefaultItemAnimator extends SimpleItemAnimator {
    ...
    public final boolean animateRemove(ViewHolder holder) {
    ...
    public final boolean animateAdd(ViewHolder holder) {
        resetAnimation(holder);
    ...
    final void animateAddImpl(final ViewHolder holder) {
        final ViewPropertyAnimatorCompat animation = ViewCompat.animate(holder.itemView);
    ...
    public final boolean animateMove(ViewHolder holder, int fromX, int fromY, int toX, int toY) {
    ...
    final void animateMoveImpl(ViewHolder holder, int fromX, int fromY, int toX, int toY) {
        View view = holder.itemView;
    ...
    public final boolean animateChange(ViewHolder oldHolder, ViewHolder newHolder, int fromX, int fromY, int toX, int toY) {
    ...
    final void animateChangeImpl(final ChangeInfo changeInfo) {
        View newView;
    ...
    public final void endAnimation(ViewHolder item) {
        int i;
    ...
    final void cancelAll(List<ViewHolder> viewHolders) {
        for (int i = viewHolders.size() - 1; i >= 0; i--) {
            ViewCompat.animate(((ViewHolder) viewHolders.get(i)).itemView).cancel();
        }
    }

    public final boolean canReuseUpdatedViewHolder(ViewHolder viewHolder, List<Object> payloads) {
