...
public class ActionMenuItemView extends AppCompatTextView implements ItemView, ActionMenuChildView, OnClickListener, OnLongClickListener {
    ...
    public final void initialize(MenuItemImpl itemData, int menuType) {
        ...
        updateTextButtonVisibility();
        this.mTitle = itemData.getTitleForItemView(this);
    ...
    public final void setItemInvoker(ItemInvoker invoker) {
    ...
    private void updateTextButtonVisibility() {
        ...
        if (this.mIcon == null || (this.mItemData.showsTextAsAction() && this.mAllowTextWithIcon)) {
            i = 1;
        }
