...
abstract class AppCompatDelegateImplBase extends AppCompatDelegate {
    ...
    private class ActionBarDrawableToggleImpl implements Delegate {
        ...
        public final Drawable getThemeUpIndicator() {
            TintTypedArray a = TintTypedArray.obtainStyledAttributes(AppCompatDelegateImplBase.this.getActionBarThemedContext(), null, new int[]{R.attr.homeAsUpIndicator});
    ...
    class AppCompatWindowCallbackBase extends WindowCallbackWrapper {
        ...
        public boolean onMenuOpened(int featureId, Menu menu) {
            ...
            AppCompatDelegateImplBase.this.onMenuOpened$2fef5512(featureId);
            return true;
        }

        public void onPanelClosed(int featureId, Menu menu) {
            super.onPanelClosed(featureId, menu);
            AppCompatDelegateImplBase.this.onPanelClosed$2fef5516(featureId);
        }
    }
