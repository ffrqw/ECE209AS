...
public class ViewPager extends ViewGroup {
    ...
    public interface OnAdapterChangeListener {
        void onAdapterChanged$49113dbb(ViewPager viewPager, PagerAdapter pagerAdapter);
    }
    ...
    final void setScrollState(int newState) {
        if (this.mScrollState != newState) {
            ...
            if (this.mOnPageChangeListeners != null) {
                ...
                for (int i = 0; i < size; i++) {
                    OnPageChangeListener onPageChangeListener = (OnPageChangeListener) this.mOnPageChangeListeners.get(i);
    ...
    public final void setAdapter(PagerAdapter adapter) {
        ...
        if (this.mAdapterChangeListeners != null && !this.mAdapterChangeListeners.isEmpty()) {
            ...
            for (i = 0; i < count; i++) {
                ((OnAdapterChangeListener) this.mAdapterChangeListeners.get(i)).onAdapterChanged$49113dbb(this, adapter);
            }
        }
    }
        ...
        if (smoothScroll) {
            if (getChildCount() == 0) {
                ...
                if (i2 == 0 && i3 == 0) {
                    ...
                    int i4 = currX / 2;
                    float sin = (((float) i4) * ((float) Math.sin((double) ((float) (((double) (Math.min(1.0f, (1.0f * ((float) Math.abs(i2))) / ((float) currX)) - 0.5f)) * 0.4712389167638204d))))) + ((float) i4);
                    int abs = Math.abs(velocity);
                    if (abs > 0) {
                        currX = Math.round(1000.0f * Math.abs(sin / ((float) abs))) * 4;
                    } else {
                        currX = (int) (((((float) Math.abs(i2)) / (((float) currX) + 0.0f)) + 1.0f) * 100.0f);
                    }
                    i4 = Math.min(currX, 600);
                    this.mIsScrollStarted = false;
                    this.mScroller.startScroll(i, scrollY, i2, i3, i4);
    ...
    public final void removeOnPageChangeListener(OnPageChangeListener listener) {
        if (this.mOnPageChangeListeners != null) {
    ...
    protected boolean verifyDrawable(Drawable who) {
        return super.verifyDrawable(who) || who == null;
    }
    ...
    final void dataSetChanged() {
        ...
        if (this.mItems.size() >= (this.mOffscreenPageLimit << 1) + 1 || this.mItems.size() >= adapterCount) {
            needPopulate = false;
        } else {
            needPopulate = true;
        }
    ...
    private void calculatePageOffsets(ItemInfo curItem, int curIndex, ItemInfo oldCurInfo) {
        ...
        float marginOffset = width > 0 ? 0.0f / ((float) width) : 0.0f;
        if (oldCurInfo != null) {
    ...
    public void onRestoreInstanceState(Parcelable state) {
        if (state instanceof SavedState) {
            ...
            if (this.mAdapter != null) {
                Parcelable parcelable = ss.adapterState;
                ClassLoader classLoader = ss.loader;
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        if (oldw <= 0 || this.mItems.isEmpty()) {
            ItemInfo infoForPosition = infoForPosition(this.mCurItem);
            int min = (int) ((infoForPosition != null ? Math.min(infoForPosition.offset, this.mLastOffset) : 0.0f) * ((float) ((w - getPaddingLeft()) - getPaddingRight())));
            if (min != getScrollX()) {
                completeScroll(false);
                scrollTo(min, getScrollY());
            }
        } else if (this.mScroller.isFinished()) {
            scrollTo((int) (((float) (((w - getPaddingLeft()) - getPaddingRight()) + 0)) * (((float) getScrollX()) / ((float) (((oldw - getPaddingLeft()) - getPaddingRight()) + 0)))), getScrollY());
        } else {
    ...
    private boolean pageScrolled(int xpos) {
        if (this.mItems.size() != 0) {
            ...
            float marginOffset = 0.0f / ((float) width);
            ...
            case 2:
                ...
                if (activePointerId != -1) {
                    ...
                    if (dx != 0.0f) {
                        ...
                        if (obj == null && canScroll(this, false, (int) dx, (int) x2, (int) y)) {
    ...
    public void draw(Canvas canvas) {
        ...
        if (overScrollMode == 0 || (overScrollMode == 1 && this.mAdapter != null && this.mAdapter.getCount() > 1)) {
            ...
            if (!this.mLeftEdge.isFinished()) {
                ...
                needsInvalidate = this.mLeftEdge.draw(canvas) | 0;
    ...
    public final void fakeDragBy(float xOffset) {
        if (!this.mFakeDragging) {
            throw new IllegalStateException("No fake drag in progress. Call beginFakeDrag first.");
    ...
    L_0x002e:
        r2 = android.support.v4.view.KeyEventCompat.hasNoModifiers(r5);
    ...
    L_0x0034:
        ...
        goto L_0x0016;
    L_0x003a:
        r2 = android.support.v4.view.KeyEventCompat.hasModifiers(r5, r1);
        if (r2 == 0) goto L_0x0015;
    L_0x0040:
