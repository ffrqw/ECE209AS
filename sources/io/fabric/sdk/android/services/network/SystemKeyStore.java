...
final class SystemKeyStore {
    ...
    public final boolean isTrustRoot(X509Certificate certificate) {
    ...
    public final X509Certificate getTrustRootFor(X509Certificate certificate) {
    ...
    private static HashMap<Principal, X509Certificate> initializeTrustedRoots(KeyStore trustStore) {
        try {
    ...
    private static KeyStore getTrustStore(InputStream keystoreStream, String passwd) {
