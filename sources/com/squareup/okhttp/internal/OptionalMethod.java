...
final class OptionalMethod<T> {
    ...
    public final boolean isSupported(T target) {
        return getMethod(target.getClass()) != null;
    }

    private Object invokeOptional(T target, Object... args) throws InvocationTargetException {
        Object obj = null;
    ...
    public final Object invokeOptionalWithoutCheckedException(T target, Object... args) {
        try {
    ...
    private Object invoke(T target, Object... args) throws InvocationTargetException {
        Method m = getMethod(target.getClass());
        if (m == null) {
    ...
    public final Object invokeWithoutCheckedException(T target, Object... args) {
        try {
