...
public abstract class RequestHandler {
    ...
    public static final class Result {
        ...
        public Result(Source source, LoadedFrom loadedFrom) {
            this(null, (Source) Utils.checkNotNull(source, "source == null"), loadedFrom, 0);
        }

        Result(Bitmap bitmap, Source source, LoadedFrom loadedFrom, int exifOrientation) {
            Object obj;
            Object obj2 = 1;
            if (bitmap != null) {
                obj = 1;
    ...
    boolean shouldRetry$552f0f64(NetworkInfo info) {
        return false;
    }
