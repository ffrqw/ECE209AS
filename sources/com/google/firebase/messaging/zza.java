                    ...
                    if (runningAppProcessInfo.pid == myPid) {
                        ...
                        if (!TextUtils.isEmpty(zze)) {
                            ...
                            if (FirebaseMessagingService.zzJ(bundle)) {
                                ...
                                zzb$4e95509e = com.google.firebase.iid.zzq.zzb$4e95509e(this.mContext, this.zzckV.incrementAndGet(), intent);
                                intent2 = new Intent("com.google.firebase.messaging.NOTIFICATION_DISMISS");
                                zza(intent2, bundle);
                                pendingIntent = com.google.firebase.iid.zzq.zzb$4e95509e(this.mContext, this.zzckV.incrementAndGet(), intent2);
                            }
                            if (zzq.isAtLeastO() || this.mContext.getApplicationInfo().targetSdkVersion <= 25) {
                                ...
                                if (zzb$4e95509e != null) {
                                    smallIcon.setContentIntent(zzb$4e95509e);
                                }
                                if (pendingIntent != null) {
                                    smallIcon.mNotification.deleteIntent = pendingIntent;
                                }
                                build = smallIcon.build();
                            } else {
                                build = zza(zzj, zzj2, identifier, zzhr, uri, zzb$4e95509e, pendingIntent, zzhs(zze(bundle, "gcm.n.android_channel_id")));
                            }
