...
public abstract class zzd<T extends IInterface> {
    ...
    protected zzd(Context context, Looper looper, int i, zzf zzf, zzg zzg) {
        this(context, looper, zzae.zzaC(context), zze.zzoW(), 93, (zzf) zzbo.zzu(zzf), (zzg) zzbo.zzu(zzg), null);
    }
    ...
    private final void zza(int i, T t) {
        ...
        synchronized (this.mLock) {
            ...
            switch (i) {
                case 1:
                    if (this.zzaGT != null) {
                        this.zzaGN.zza(zzdb(), "com.google.android.gms", this.zzaGT, zzra());
                        this.zzaGT = null;
                        break;
                    }
                    break;
                ...
                case 3:
                    ...
                    this.zzaGM = new zzak("com.google.android.gms", zzdb());
                    if (!this.zzaGN.zza(new zzaf(this.zzaGM.zzrE(), this.zzaGM.getPackageName()), this.zzaGT, zzra())) {
                        ...
                        zza$4c85f423(16, this.zzaHb.get());
                        break;
                    }
                    break;
                case 4:
    ...
    public final void zza(zzal zzal, Set<Scope> set) {
        ...
        try {
            ...
            this.mHandler.sendMessage(this.mHandler.obtainMessage(6, this.zzaHb.get(), 1));
    ...
    public final void zzrb() {
        ...
        if (isGooglePlayServicesAvailable != 0) {
            zza(1, null);
            this.zzaGQ = (zzj) zzbo.zzb(new zzm(this), (Object) "Connection progress callbacks cannot be null.");
            this.mHandler.sendMessage(this.mHandler.obtainMessage(3, this.zzaHb.get(), isGooglePlayServicesAvailable, null));
            return;
        }
        zza(new zzm(this));
    }
    ...
    static /* synthetic */ void zza$66ee2deb(zzd zzd) {
        int i;
        if (zzd.zzrc()) {
            i = 5;
            zzd.zzaHa = true;
        ...
        zzd.mHandler.sendMessage(zzd.mHandler.obtainMessage(i, zzd.zzaHb.get(), 16));
    }
}
