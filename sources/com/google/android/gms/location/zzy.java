...
public final class zzy extends zza {
    ...
    public final String toString() {
        ...
        stringBuilder.append(" Wifi status: ").append(this.zzbit).append(" Cell status: ").append(this.zzbiu).append(" elapsed time NS: ").append(this.zzbiw).append(" system time ms: ").append(this.zzbiv);
