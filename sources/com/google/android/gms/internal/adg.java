...
public final class adg {
    ...
    private int zzcrW;
    private int zzcrX;
    private int zzcrY = ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED;
    private int zzcrZ;
    ...
    public static adg zzb$2f392411(byte[] bArr, int i) {
        return new adg(bArr, 0, i);
    }
    ...
    public final int zzLL() {
        if (this.zzcrY == ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED) {
            return -1;
        }
