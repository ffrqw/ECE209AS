...
public final class zzcga {
    ...
    public final void zzf$505cfb5b(String str) {
        this.zzbrF.zzjC();
        if (zzmc() == 0) {
            zzma();
        }
        ...
        long j = this.zzbrF.zzaix.getLong(this.zzbrI, 0);
        if (j <= 0) {
            Editor edit = this.zzbrF.zzaix.edit();
        ...
        Object obj = (this.zzbrF.zzwB().zzzt().nextLong() & Long.MAX_VALUE) < Long.MAX_VALUE / (j + 1) ? 1 : null;
        Editor edit2 = this.zzbrF.zzaix.edit();
        if (obj != null) {
            edit2.putString(this.zzbrJ, str);
        }
        edit2.putLong(this.zzbrI, j + 1);
        edit2.apply();
    }
