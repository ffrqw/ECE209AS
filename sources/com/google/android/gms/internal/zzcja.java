...
public final class zzcja extends zzchj {
    ...
    static /* synthetic */ void zza(zzcja zzcja, long j) {
        super.zzjC();
        zzcja.zzzn();
        zzcja.zzbus.cancel();
        zzcja.zzbut.cancel();
        ...
        if (super.zzwG().zzbrz.get()) {
            zzcja.zzbus.zzs(Math.max(0, super.zzwG().zzbrx.get() - super.zzwG().zzbrB.get()));
        } else {
            zzcja.zzbut.zzs(Math.max(0, 3600000 - super.zzwG().zzbrB.get()));
        }
    }
    ...
    static /* synthetic */ void zza(zzcja zzcja) {
        super.zzjC();
        zzcja.zzap(false);
        super.zzwr().zzJ(super.zzkq().elapsedRealtime());
    }

    static /* synthetic */ void zzb(zzcja zzcja, long j) {
        super.zzjC();
        zzcja.zzzn();
        zzcja.zzbus.cancel();
        zzcja.zzbut.cancel();
        ...
        if (zzcja.zzbur != 0) {
            super.zzwG().zzbrB.set(super.zzwG().zzbrB.get() + (j - zzcja.zzbur));
        }
    }
}
