...
public final class zzans {
    ...
    private static zzant<Float> zzahi = zzant.zza$58a3506f("analytics.tokens_per_sec");
    ...
    static {
        ...
        str = "404,502";
        zzahF = zzant.zzc("analytics.fallback_responses.k", str, str);
        str = "";
        zzahL = zzant.zzc("analytics.first_party_experiment_id", str, str);
    }
}
