...
final class zzcht implements Runnable {
    ...
    zzcht(zzchl zzchl, String str, String str2, long j, Bundle bundle, boolean z, boolean z2, boolean z3, String str3) {
        this.zzbtt = zzchl;
        this.zzbth = str;
        this.val$name = str2;
        this.zzbty = j;
    ...
    public final void run() {
        zzchl.zza(this.zzbtt, this.zzbth, this.val$name, this.zzbty, this.zzbtz, this.zzbtA, this.zzbtB, this.zzbtC, this.zzbjh);
    }
}
