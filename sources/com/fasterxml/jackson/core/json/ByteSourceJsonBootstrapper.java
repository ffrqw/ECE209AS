...
public final class ByteSourceJsonBootstrapper {
    ...
    public final JsonEncoding detectEncoding() throws IOException {
        JsonEncoding enc;
    ...
    public final JsonParser constructParser(int parserFeatures, ObjectCodec codec, ByteQuadsCanonicalizer rootByteSymbols, CharsToNameCanonicalizer rootCharSymbols, int factoryFeatures) throws IOException {
    ...
    protected final boolean ensureLoaded(int minimum) throws IOException {
