...
public final class TextBuffer {
    ...
    public final void resetWithCopy(char[] buf, int start, int len) {
        this._inputBuffer = null;
        this._inputStart = -1;
        this._inputLen = 0;
        this._resultString = null;
    ...
    public final void resetWithString(String value) {
        this._inputBuffer = null;
        this._inputStart = -1;
        this._inputLen = 0;
    ...
    public final int contentsToWriter(Writer w) throws IOException {
        if (this._resultArray != null) {
    ...
    public final void append(char[] c, int start, int len) {
        if (this._inputStart >= 0) {
            unshare(len);
        }
        this._resultString = null;
    ...
    public final void append(String str, int offset, int len) {
        if (this._inputStart >= 0) {
            unshare(len);
        }
        this._resultString = null;
    ...
    public final void setCurrentLength(int len) {
        this._currentSize = len;
    }

    public final String setCurrentAndReturn(int len) {
        this._currentSize = len;
