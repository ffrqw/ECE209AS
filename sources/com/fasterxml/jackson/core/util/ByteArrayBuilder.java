...
public final class ByteArrayBuilder extends OutputStream {
    ...
    public final void appendTwoBytes(int b16) {
    ...
    public final void appendThreeBytes(int b24) {
    ...
    public final byte[] completeAndCoalesce(int lastBlockLength) {
    ...
    public final void setCurrentSegmentLength(int len) {
