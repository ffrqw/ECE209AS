...
public abstract class ParserBase extends ParserMinimalBase {
    ...
    protected void _handleEOF() throws JsonParseException {
        if (!this._parsingContext.inRoot()) {
            ...
            _reportInvalidEOF(String.format(": expected close marker for %s (start marker at %s)", new Object[]{marker, this._parsingContext.getStartLocation(this._ioContext.getSourceReference())}), null);
        }
    }
