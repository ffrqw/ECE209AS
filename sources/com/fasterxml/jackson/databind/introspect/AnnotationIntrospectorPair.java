...
public class AnnotationIntrospectorPair extends AnnotationIntrospector implements Serializable {
    ...
    public Value findPropertyIgnorals(Annotated a) {
        Value v2 = this._secondary.findPropertyIgnorals(a);
        Value v1 = this._primary.findPropertyIgnorals(a);
    ...
    public String[] findPropertiesToIgnore(Annotated ac, boolean forSerialization) {
        ...
        if (result == null) {
            return this._secondary.findPropertiesToIgnore(ac, forSerialization);
        }
        return result;
    }
    ...
    public String findClassDescription(AnnotatedClass ac) {
        ...
        if (str == null || str.isEmpty()) {
            return this._secondary.findClassDescription(ac);
        }
        return str;
    }
    ...
    public Access findPropertyAccess(Annotated ann) {
        Access acc = this._primary.findPropertyAccess(ann);
    ...
    public AnnotatedMethod resolveSetterConflict(MapperConfig<?> config, AnnotatedMethod setter1, AnnotatedMethod setter2) {
        ...
        if (res == null) {
            return this._secondary.resolveSetterConflict(config, setter1, setter2);
        }
        return res;
    }

    public JavaType refineSerializationType(MapperConfig<?> config, Annotated a, JavaType baseType) throws JsonMappingException {
        return this._primary.refineSerializationType(config, a, this._secondary.refineSerializationType(config, a, baseType));
    }
    ...
    public JavaType refineDeserializationType(MapperConfig<?> config, Annotated a, JavaType baseType) throws JsonMappingException {
        return this._primary.refineDeserializationType(config, a, this._secondary.refineDeserializationType(config, a, baseType));
    }
    ...
    public Mode findCreatorBinding(Annotated a) {
        Mode mode = this._primary.findCreatorBinding(a);
