...
public class BasicClassIntrospector extends ClassIntrospector implements Serializable {
    ...
    public BasicBeanDescription forClassAnnotations(MapperConfig<?> config, JavaType type, MixInResolver r) {
        ...
        desc = BasicBeanDescription.forOtherUse(config, type, AnnotatedClass.construct(type, config, r));
    ...
    public BasicBeanDescription forDirectClassAnnotations(MapperConfig<?> config, JavaType type, MixInResolver r) {
        BasicBeanDescription desc = _findStdTypeDesc(type);
        if (desc == null) {
            return BasicBeanDescription.forOtherUse(config, type, AnnotatedClass.constructWithoutSuperTypes(type.getRawClass(), config, r));
        }
        return desc;
    }
