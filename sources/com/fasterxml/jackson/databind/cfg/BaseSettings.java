...
public final class BaseSettings implements Serializable {
    ...
    public final BaseSettings withClassIntrospector(ClassIntrospector ci) {
    ...
    public final BaseSettings withAnnotationIntrospector(AnnotationIntrospector ai) {
    ...
    public final BaseSettings withInsertedAnnotationIntrospector(AnnotationIntrospector ai) {
        return withAnnotationIntrospector(AnnotationIntrospectorPair.create(ai, this._annotationIntrospector));
    }

    public final BaseSettings withAppendedAnnotationIntrospector(AnnotationIntrospector ai) {
        return withAnnotationIntrospector(AnnotationIntrospectorPair.create(this._annotationIntrospector, ai));
    }

    public final BaseSettings withVisibilityChecker(VisibilityChecker<?> vc) {
    ...
    public final BaseSettings withVisibility(PropertyAccessor forMethod, Visibility visibility) {
    ...
    public final BaseSettings withPropertyNamingStrategy(PropertyNamingStrategy pns) {
    ...
    public final BaseSettings withTypeFactory(TypeFactory tf) {
    ...
    public final BaseSettings withTypeResolverBuilder(TypeResolverBuilder<?> typer) {
    ...
    public final BaseSettings withHandlerInstantiator(HandlerInstantiator hi) {
    ...
    public final BaseSettings with(Locale l) {
        if (this._locale == l) {
            return this;
        }
    ...
    public final BaseSettings with(TimeZone tz) {
        if (tz == null) {
            throw new IllegalArgumentException();
        } else if (tz == this._timeZone) {
            return this;
        } else {
            return new BaseSettings(this._classIntrospector, this._annotationIntrospector, this._visibilityChecker, this._propertyNamingStrategy, this._typeFactory, this._typeResolverBuilder, _force(this._dateFormat, tz), this._handlerInstantiator, this._locale, tz, this._defaultBase64);
        }
    }

    public final BaseSettings with(Base64Variant base64) {
