...
public class SimpleType extends TypeBase {
        ...
        if (this._class.isAssignableFrom(subclass)) {
            ...
            if (next == this._class) {
                ...
                while (i$ < len$) {
                    ...
                    } else if (this._class.isAssignableFrom(iface)) {
                ...
                throw new IllegalArgumentException("Internal error: Can not resolve sub-type for Class " + subclass.getName() + " to " + this._class.getName());
            } else {
                return new SimpleType(subclass, this._bindings, _narrow(next), null, this._valueHandler, this._typeHandler, this._asStatic);
            }
        }
        return new SimpleType(subclass, this._bindings, this, this._superInterfaces, this._valueHandler, this._typeHandler, this._asStatic);
    }
    ...
    private static JavaType _buildSuperClass(Class<?> superClass, TypeBindings b) {
        ...
        return new SimpleType(superClass, b, _buildSuperClass(superClass.getSuperclass(), b), null, null, null, false);
    }
