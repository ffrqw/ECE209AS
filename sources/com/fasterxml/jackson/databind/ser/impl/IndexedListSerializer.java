...
public final class IndexedListSerializer extends AsArraySerializerBase<List<?>> {
    ...
    public final IndexedListSerializer withResolved(BeanProperty property, TypeSerializer vts, JsonSerializer<?> elementSerializer, Boolean unwrapSingle) {
        return new IndexedListSerializer(this, property, vts, elementSerializer, unwrapSingle);
    }

    public final boolean isEmpty(SerializerProvider prov, List<?> value) {
        return value == null || value.isEmpty();
    }

    public final boolean hasSingleElement(List<?> value) {
        return value.size() == 1;
    }
    ...
    public final void serializeContents(List<?> value, JsonGenerator jgen, SerializerProvider provider) throws IOException {
    ...
    public final void serializeContentsUsing(List<?> value, JsonGenerator jgen, SerializerProvider provider, JsonSerializer<Object> ser) throws IOException {
        int len = value.size();
        if (len != 0) {
    ...
    public final void serializeTypedContents(List<?> value, JsonGenerator jgen, SerializerProvider provider) throws IOException {
        int len = value.size();
        if (len != 0) {
            int i = 0;
            try {
