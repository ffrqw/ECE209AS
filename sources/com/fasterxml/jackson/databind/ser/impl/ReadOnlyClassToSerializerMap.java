...
public final class ReadOnlyClassToSerializerMap {
    ...
    private static final class Bucket {
        ...
        public final boolean matchesTyped(Class<?> key) {
            return this._class == key && this._isTyped;
        }

        public final boolean matchesUntyped(Class<?> key) {
            return this._class == key && !this._isTyped;
        }

        public final boolean matchesTyped(JavaType key) {
            return this._isTyped && key.equals(this._type);
        }

        public final boolean matchesUntyped(JavaType key) {
            return !this._isTyped && key.equals(this._type);
        }
    }
    ...
    public final JsonSerializer<Object> typedValueSerializer(Class<?> type) {
        Bucket bucket = this._buckets[TypeKey.typedHash((Class) type) & this._mask];
        if (bucket == null) {
            return null;
        }
        if (bucket.matchesTyped((Class) type)) {
            return bucket.value;
        }
        do {
            bucket = bucket.next;
        ...
        } while (!bucket.matchesTyped((Class) type));
        return bucket.value;
    }
    ...
    public final JsonSerializer<Object> untypedValueSerializer(Class<?> type) {
        Bucket bucket = this._buckets[TypeKey.untypedHash((Class) type) & this._mask];
        if (bucket == null) {
            return null;
        }
        if (bucket.matchesUntyped((Class) type)) {
            return bucket.value;
        }
        do {
            bucket = bucket.next;
        ...
        } while (!bucket.matchesUntyped((Class) type));
        return bucket.value;
    }
}
