...
public abstract class BeanSerializerBase extends StdSerializer<Object> implements JsonFormatVisitable, SchemaAware, ContextualSerializer, ResolvableSerializer {
    ...
    public JsonSerializer<?> createContextual(SerializerProvider provider, BeanProperty property) throws JsonMappingException {
                ...
                if (implClass == PropertyGenerator.class) {
                    ...
                    while (i != len) {
                        ...
                        if (propName.equals(prop.getName())) {
                            ...
                            oiw = ObjectIdWriter.construct(idProp.getType(), null, new PropertyBasedObjectIdGenerator(objectIdInfo, idProp), objectIdInfo.getAlwaysAsId());
                        } else {
                            i++;
                        }
                    }
        ...
        if (!(ignoredProps == null || ignoredProps.isEmpty())) {
            contextual = contextual.withIgnorals((Set) ignoredProps);
        }
        if (newFilterId != null) {
    ...
    protected void serializeFields(Object bean, JsonGenerator gen, SerializerProvider provider) throws IOException {
        ...
        try {
            ...
            JsonMappingException mapE = new JsonMappingException((Closeable) gen, "Infinite recursion (StackOverflowError)", e2);
            ...
            if (objectVisitor != null) {
                ...
                if (this._propertyFilterId != null) {
                    ...
                    for (PropertyWriter depositSchemaProperty : this._props) {
                        filter.depositSchemaProperty(depositSchemaProperty, objectVisitor, provider);
                    }
                    return;
                }
