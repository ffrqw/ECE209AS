...
public class MapSerializer extends ContainerSerializer<Map<?, ?>> implements ContextualSerializer {
    ...
    public static MapSerializer construct(String[] ignoredList, JavaType mapType, boolean staticValueType, TypeSerializer vts, JsonSerializer<Object> keySerializer, JsonSerializer<Object> valueSerializer, Object filterId) {
        Set ignoredEntries = (ignoredList == null || ignoredList.length == 0) ? null : ArrayBuilders.arrayToSet(ignoredList);
        return construct(ignoredEntries, mapType, staticValueType, vts, (JsonSerializer) keySerializer, (JsonSerializer) valueSerializer, filterId);
    }
    ...
    public JsonSerializer<?> createContextual(SerializerProvider provider, BeanProperty property) throws JsonMappingException {
        ...
        MapSerializer mser = withResolved(property, keySer, ser, ignored, z);
        if (suppressableValue != this._suppressableValue) {
    ...
    public boolean isEmpty(SerializerProvider prov, Map<?, ?> value) {
        ...
        Include supp = this._suppressableValue;
        ...
        for (Object elemValue2 : value.values()) {
            if (elemValue2 != null) {
                ...
                if (!valueSer.isEmpty(prov, elemValue2)) {
                    return false;
                }
            }
        }
    ...
    public void serializeOptionalFields(Map<?, ?> value, JsonGenerator gen, SerializerProvider provider, Object suppressableValue) throws IOException {
        ...
        for (Entry<?, ?> entry : value.entrySet()) {
            ...
            if (valueElem != null) {
                ...
                if (suppressableValue == Include.NON_EMPTY) {
