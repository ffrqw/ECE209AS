...
public class RuntimeExceptionDao<T, ID> implements Dao<T, ID> {
    ...
    public static <T, ID> RuntimeExceptionDao<T, ID> createDao(ConnectionSource connectionSource, Class<T> clazz) throws SQLException {
        return new RuntimeExceptionDao(DaoManager.createDao(connectionSource, (Class) clazz));
    }
    ...
    public static <T, ID> RuntimeExceptionDao<T, ID> createDao(ConnectionSource connectionSource, DatabaseTableConfig<T> tableConfig) throws SQLException {
        return new RuntimeExceptionDao(DaoManager.createDao(connectionSource, (DatabaseTableConfig) tableConfig));
    }
    ...
    public int create(T data) {
        try {
            return this.dao.create((Object) data);
        } catch (SQLException e) {
    ...
    public int create(Collection<T> datas) {
        try {
            return this.dao.create((Collection) datas);
        } catch (SQLException e) {
    ...
    public <UO> GenericRawResults<UO> queryRaw(String query, RawRowMapper<UO> mapper, String... arguments) {
        try {
            return this.dao.queryRaw(query, (RawRowMapper) mapper, arguments);
        } catch (SQLException e) {
            logMessage(e, "queryRaw threw exception on: " + query);
            throw new RuntimeException(e);
        }
    ...
    public <UO> GenericRawResults<UO> queryRaw(String query, DatabaseResultsMapper<UO> mapper, String... arguments) {
        try {
            return this.dao.queryRaw(query, (DatabaseResultsMapper) mapper, arguments);
        } catch (SQLException e) {
            logMessage(e, "queryRaw threw exception on: " + query);
            throw new RuntimeException(e);
        }
