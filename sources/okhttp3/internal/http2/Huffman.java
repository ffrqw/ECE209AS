...
final class Huffman {
    ...
    static void encode(ByteString data, BufferedSink sink) throws IOException {
        long current = 0;
        int n = 0;
    ...
    static int encodedLength(ByteString bytes) {
        long len = 0;
