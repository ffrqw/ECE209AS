...
public final class BridgeInterceptor implements Interceptor {
    ...
    public final Response intercept(Chain chain) throws IOException {
        ...
        List<Cookie> cookies = this.cookieJar.loadForRequest$792063fe();
        if (!cookies.isEmpty()) {
            String str = "Cookie";
            ...
            requestBuilder.header(str, stringBuilder.toString());
        }
        if (userRequest.header("User-Agent") == null) {
            requestBuilder.header("User-Agent", "okhttp/3.6.0");
        }
